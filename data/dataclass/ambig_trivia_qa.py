...
class AmbigTriviaQA(BaseDataset):
    def __init__(self, 
                 name:str, 
                 data_path:str,
                 seed:int=1234) -> None:
    ...
    def _load_dataset(self, filename:str='ambig_trivia_qa.jsonl') -> List[Dict]:
    ...
    def get_dataset(self) -> Dataset:
        ...
        ## load dataset from file
        test_data = self._load_dataset(filename='ambig_trivia_qa.jsonl')
